...
* Before class:
    + Skim [_bookdown: Authoring Books and Technical Documents with R Markdown_](https://bookdown.org/yihui/bookdown/)
...
* Discuss [Cross-Validation Hand Out](../Rmarkdown/Cross-ValidationInClassHO.pdf)
* Quiz #9
...
* Complete [Reproduce _Lab: Cross-Validation_](../Rmarkdown/LabCrossValidation.html).  Submit your html file to [CrowdGrader](	) no later than 5 pm March 31.
...
* Make sure a single `.Rmd` with the sections outlined in the [Example Paper](../BDbetaTemplate/MoreTemplates/main.html) is in your `Project2` directory under your private course repository.  This is 10% of the assignment grade.
...
* Final - Present Poster 12-2:30

### Poster Groups:

1.  AmandaLake, Kelly, Will
2.  Mara, Tori, Tanner
3.  Hannah, Tucker, Andrew
4.  Ben (A), Cecily, Ollie
5.  Alexis, Sana, Stephen (C)
6.  Ben (J), Mary, Ronnie
7.  Zach, Hunter, Brad
8.  Kevin, Steven (K), Austin   
9.  Clark, Michael, Jamie
10. Rami, Brandon, Khairi
